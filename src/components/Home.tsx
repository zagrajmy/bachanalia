          ...
          <div className="relative min-w-0">
            <div className="relative">
              <Image
                ...
                className="object-cover object-right [@media(width>1850px)]:object-contain xl:object-right [@media(width>1900px)]:object-[55%_45%] absolute inset-0 aspect-auto"
                fill
                priority
                sizes="100vw"
                src={KEY_ART}
              ...
              <span
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 bg-linear-to-r from-navy from-15% sm:from-25% to-transparent to-80% sm:to-70% lg:opacity-80"
              />

              <div className="gutter relative mx-auto max-w-6xl px-5 pt-7 pb-10 sm:px-8 sm:pt-9 sm:pb-14 lg:flex lg:min-h-135 [@media(width>1900px)]:min-h-180 lg:flex-col lg:justify-center lg:py-16 lg:px-0">
                ...
                <dl className="relative mt-7 grid max-w-136 gap-x-7 gap-y-3 text-sm sm:grid-cols-[auto_1fr] sm:text-base">
