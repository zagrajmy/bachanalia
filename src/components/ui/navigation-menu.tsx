...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-card bg-transparent px-2 py-2 text-sm whitespace-nowrap text-ink no-underline underline-offset-[0.35em] transition-[color,box-shadow] outline-none hover:underline focus:underline data-[state=open]:underline xl:px-3",
);
